      ...
      <div className="w-full md:w-1/2 text-center md:text-left">
        <div>
          <p className="mt-8 md:mt-14 font-bold text-3xl md:text-[40px] text-blue-900">
            Hello, i'm Ayoade Clinton
          </p>
          <p className="font-bold text-xl md:text-[25px] text-blue-900 pt-3">
            Software Engineer
          </p>
        </div>
        <div>
          <p className="mt-6 md:mt-8 w-full md:w-[500px] text-base md:text-[18px] text-gray-700 font-semibold leading-relaxed">
          I'm a problem solver, code enthusiast, and digital innovator bridging challenges with creative solutions. </p>
        </div>
