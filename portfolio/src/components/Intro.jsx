...
const Intro = () => {
  return (
    <div className='intro-container flex justify-between items-center mt-[70px] max-w-[1240px] mx-auto px-4' >
        <div className=' w-1/2'>
        <div>
        ...
        <button className='px-4 py-2  bg-[#007BFF] hover:bg-[#0056D2] text-white text-[16px] font-medium rounded mt-4 ml-8'>View CV</button>
        </div>
        <div className=''>
